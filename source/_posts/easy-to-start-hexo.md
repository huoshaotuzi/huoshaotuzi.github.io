...
本教程基于 Linux 系统，如果是 Window 系统也不用急，只是增加一个配置环境变量的步骤，相信机智的你一定懂得怎么做！
...
再者，如果你选国内服务器，那还得有备案的域名才能用，至于如何备案，服务器提供商会告诉你。

这里只讲技术，不讨论那些无关技术的东西。

但是有一点务必注意，你的域名在哪买的跟在哪备案没关系，比方说你在阿里云买域名，可以到腾讯云去备案。

但是你在哪备案就一定要买那里的服务器，不然备了案也不能解析到服务器。

比如你在阿里云备案，那你就要买阿里云的服务器，买腾讯云的服务器就是不行。

你在阿里云备案，想用腾讯云服务器，就得备案转移。

（备案和备案转移极其麻烦，审核周期动辄十天半个月，工信部拖你 1 个月也没办法）

想要搭建博客，最好提前买个域名进行备案。

除了在哪备案的问题，还需要知道在我们国家大陆地区，有的域名是备不了案的，买域名的时候不要觉得很酷瞎买，像程序员特喜欢的 io 域名在国内是备不了案的。备不了案的域名只能选择国外主机。

只建议购买：com、cn、net 这三个老牌域名。

非主流域名即使能备案，搜索引擎也很难收录，对你以后的发展非常不好。
