...
Centos 搭建 Gitlab：[Centos 系统安装 Gitlab](https://blog.huotuyouxi.com/centos-install-gitlab)
Docker 搭建 Gitlab：[再战！Docker 安装 Gitlab](https://blog.huotuyouxi.com/docker-install-gitlab)

## 上传 Composer 包
Composer 包开发教程：[从零开始开发自己的包](https://blog.huotuyouxi.com/composer-package)
