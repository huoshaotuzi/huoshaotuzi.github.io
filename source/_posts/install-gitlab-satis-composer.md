...
Centos 搭建 Gitlab：[Centos 系统安装 Gitlab](https://idce.com/document/VnmQ)
Docker 搭建 Gitlab：[再战！Docker 安装 Gitlab](https://idce.com/document/QRy0)

## 上传 Composer 包
Composer 包开发教程：[从零开始开发自己的包](https://idce.com/document/0b60)
